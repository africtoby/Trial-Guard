...
const CANCELLATION_DIRECTORY: Record<string, string> = {
  ...
  tinder: 'https://tinder.com/app/settings/subscriptions',
  bumble: 'https://bumble.com/app/settings',
  ...
  coursera: 'https://www.coursera.org/my-purchases',
  audible: 'https://www.audible.com/account/details',
  shopify: 'https://admin.shopify.com/settings/billing',
  squarespace: 'https://account.squarespace.com/',
  wix: 'https://manage.wix.com/billing/subscriptions',
  nordvpn: 'https://my.nordaccount.com/billing/',
  expressvpn: 'https://www.expressvpn.com/sign-in',
  surfshark: 'https://my.surfshark.com/account/subscriptions',
  cyberghost: 'https://my.cyberghostvpn.com/login',
  protonvpn: 'https://account.proton.me/u/0/mail/subscriptions',
  pia: 'https://www.privateinternetaccess.com/pages/client-sign-in',
  tunnelbear: 'https://www.tunnelbear.com/account#/overview',
  windscribe: 'https://windscribe.com/myaccount',
  discord: 'https://discord.com/app',
  capcut: 'https://www.capcut.com/help/cancel-subscription',
  picsart: 'https://picsart.com/settings',
  telegram: 'https://telegram.org/faq_premium#q-how-can-i-cancel-my-subscription',
  '1password': 'https://my.1password.com/billing',
  'apple one': 'https://support.apple.com/HT202039', 
  'microsoft 365': 'https://account.microsoft.com/services/microsoft365', 
};
